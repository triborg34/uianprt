...
class Tempcamra extends StatefulWidget {
  const Tempcamra({super.key});

  @override
  State<Tempcamra> createState() => _TempcamraState();
}

class _TempcamraState extends State<Tempcamra> {
